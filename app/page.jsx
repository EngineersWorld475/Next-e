  ...
  return (
    <>
      <div className="relative">
        <Navbar />
        <Button onClick={() => setOpenFeedbackDialogue(true)} className={`${inter.className} fixed top-1/3 right-10 transform -translate-y-1/3 rotate-90 bg-[#ff6347] origin-bottom-right z-20`}>🚀 Feedback</Button>
        {/* section 1 */}
        <div className="flex flex-col justify-center items-center h-72 gap-3 shadow-md">
          <h1 className="text-4xl text-gray-700 font-semibold text-center mt-14 md:mt-10">
            <span className={`${inter.className} block sm:inline`}>Welcome to</span>
            <span className={`${inter.className} block sm:inline`}> Scholarly</span>
          </h1>
          <p className="text-customGrayBlue px-4">
            <span className={`${inter.className} block sm:inline`}>"A good scientist (or student) knows the</span>
            <span className={`${inter.className} block sm:inline`}>right answers. A great scientist (or student)</span>
            <span className={`${inter.className} block sm:inline`}> knows the right questions." Author unknown</span>
          </p>
        </div>
        {/* section 2 */}
        <div className="bg-[#FCE8BD] h-full md:h-72 lg:h-72 flex flex-col md:flex-row">
          <div className="w-full md:w-2/3 md:py-10 md:px-28 px-5 py-5">
            <p className={`${inter.className} text-[#3a3a3a]`}>What is Scholarly?</p>
            <p className={`${inter.className} w-full text-[#3a3a3a]`}>
        ...
        <div className=" h-full md:h-72 lg:h-72 flex flex-col md:flex-row">
          ...
          <div className="flex flex-col gap-3 justify-center w-full md:w-2/3 overflow-hidden w-30 px-5 py-5">
            <h1 className={`${inter.className} text-gray-600`}>Who should use Scholarly?</h1>
            <p className={`${inter.className} w-full text-customGrayBlue`}>Do you read research articles? Have you ever faced a situation that you read an article but somehow missed “that point”? Did you ever fell that you understood an article better after discussion? If your answer is Yes, Scholarly is for you!! Scholarly is for students, researchers, and scientists in all fields of sciences who intend to acquire new insights with a click of a button.</p>
          </div>
        </div>
        {/* section 4 */}
        <div className={`${inter.className} bg-[#FCE8BD] h-full md:h-72 lg:h-72 flex flex-col md:flex-row lg:flex-row overflow-hidden`}>
          <div className="w-full md:w-2/3 md:py-10 md:px-28 px-5 py-5">
            <p className={`${inter.className} text-[#3a3a3a]`}>Who are we and what are we up to?</p>
            <p className={`${inter.className} w-full text-[#3a3a3a]`}>
      ...
      <Sheet open={openFeedbackDialogue} onOpenChange={() => (
        ...
        <SheetContent side="right" className="overflow-auto bg-white transition-all duration-500 ease-in-out transform" aria-describedby="feedback-description" >
          <SheetTitle className={`${inter.className} text-[#ff6347] text-2xl`}>Feedback</SheetTitle>
