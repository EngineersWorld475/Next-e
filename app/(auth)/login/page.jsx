...
const LoginPage = () => {
  ...
  return (
    <>
      ...
      <form className={`${inter.className} flex flex-col space-y-4 text-black`} onSubmit={handleLogin}>
            <div>
            ...
            <div className={`${inter.className} flex justify-center mt-1 text-blue-500 text-sm`}>
